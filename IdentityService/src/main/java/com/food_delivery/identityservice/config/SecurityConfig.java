package com.food_delivery.identityservice.config;
...
import com.food_delivery.identityservice.jwt.JwtFilter;
import com.food_delivery.identityservice.service.CustomUserDetailsService;
	    ...
	    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
	        http
	            ...
	            .authorizeHttpRequests(auth -> auth
	                .requestMatchers("/auth/register", "/auth/login", "/auth/checkUserAvailable/**").permitAll() // Public endpoints
